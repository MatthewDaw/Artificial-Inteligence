...
class Environment(object):
    ...
    def __init__(self, optimal_temperature = (10.0, 24.0), initial_month = 0, initial_number_users = 10, initial_rate_data = 60):
        ...
        self.game_over = 0
        self.train = 1
    # MAKING A METHOD THAT UPDATES THE ENVIRONMENT RIGHT AFTER THE ASI PLAYS AN ACTION
    ...
    #MAKING A METHOD THAT GIVES US AT ANY TIME THE CURRENT STATE, THE LAST REWARD, AND WHETHER THE GAME IS FINISHED
